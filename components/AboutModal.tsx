...
import { SparklesIcon, UploadIcon, LanguageIcon, VideoPlusIcon, BriefcaseIcon, MailIcon, SignatureIcon, TypographyIcon } from './icons';
...
export const AboutModal: React.FC<AboutModalProps> = ({ isOpen, onClose }) => {
  ...
  const features = [
    ...
    { icon: <LanguageIcon className="w-6 h-6 text-indigo-600" />, title: 'Multi-Language Support', description: 'Generate your CV in multiple languages, including local dialects, to apply for jobs anywhere in the world.' },
